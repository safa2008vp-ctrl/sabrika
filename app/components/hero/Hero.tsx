    ...
    <section className="relative flex min-h-screen items-center overflow-hidden bg-[#050505] text-white">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 py-28 lg:px-8">
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          >
            <div className="relative flex h-[560px] w-[560px] items-center justify-center rounded-[45px] border border-white/10 bg-white/5 backdrop-blur-3xl shadow-[0_0_80px_rgba(139,92,246,0.25)]">
              ...
              <img
                src="/logo2.png"
                alt="SABRIKA"
                className="relative z-10 w-72 drop-shadow-[0_0_60px_rgba(139,92,246,.8)]"
              />
